...
class SalesContractItemTest {

    @Test
    void shouldCreateEntityWithDefaultValues() {
        var entity = new SalesContractItem();
        assertThat(entity.getId()).isNull();
        assertThat(entity.getSalesContract()).isNull();
    ...
    @Test
    void shouldSetAndGetSalesContract() {
        var entity = new SalesContractItem();
        var contract = new SalesContract();
        contract.setId(100L);
        entity.setSalesContract(contract);
        assertThat(entity.getSalesContract()).isSameAs(contract);
        assertThat(entity.getSalesContract().getId()).isEqualTo(100L);
    }
