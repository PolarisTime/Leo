...
class PrintTemplateFileSyncRunnerTest {
    ...
    void shouldSyncFileManagedTemplateFromClasspath() {
        ...
        new PrintTemplateFileSyncRunner(repository).run(new DefaultApplicationArguments());
    ...
    void shouldSkipWhenChecksumAndContentAreCurrent() {
        ...
        new PrintTemplateFileSyncRunner(repositoryWithSingle(template)).run(new DefaultApplicationArguments());
