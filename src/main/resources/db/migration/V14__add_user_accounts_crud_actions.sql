...
VALUES
    (100042, 'user-account', 'CREATE', '新增'),
    (100043, 'user-account', 'EDIT',   '编辑'),
    (100044, 'user-account', 'DELETE', '删除')
...
WHERE r.role_code = 'ADMIN'
  AND (
    (ma.menu_code = 'user-account' AND ma.action_code IN ('CREATE', 'EDIT', 'DELETE'))
