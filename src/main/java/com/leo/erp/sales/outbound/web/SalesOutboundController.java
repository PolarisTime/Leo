...
public class SalesOutboundController {
    ...
    @DomainEventAudited
    public ApiResponse<SalesOutboundResponse> createAndAudit(@Valid @RequestBody SalesOutboundRequest request) {
    ...
    @Operation(summary = "保存并审核销售出库")
    @DomainEventAudited
    public ApiResponse<SalesOutboundResponse> updateAndAudit(
