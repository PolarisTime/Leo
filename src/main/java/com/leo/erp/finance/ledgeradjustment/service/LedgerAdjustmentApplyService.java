...
@Service
public class LedgerAdjustmentApplyService {
    ...
    public LedgerAdjustmentApplyService(CustomerQuery customerQuery,
    ...
    void apply(LedgerAdjustment entity, LedgerAdjustmentRequest request) {
    ...
    private ResolvedProject resolveProject(String counterpartyType,
        ...
        return projectQuery.findActiveById(projectId)
                .map(project -> {
                    if (!Objects.equals(project.customerId(), counterpartyId)) {
