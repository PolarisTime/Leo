...
public class SnowflakeIdGenerator {
    ...
    /** For bootstrap / test use when @PostConstruct has not run yet. */
    public static void registerInstance(SnowflakeIdGenerator generator) {
        if (instance == null) {
            instance = generator;
        }
    }

    /** Static accessor for use in CGLIB-proxied abstract services where constructor injection is bypassed. */
