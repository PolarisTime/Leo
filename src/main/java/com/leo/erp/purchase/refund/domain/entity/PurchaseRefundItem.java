...
@Setter
@Entity
@Table(name = "po_purchase_refund_item")
public class PurchaseRefundItem {
    ...
    private PurchaseRefund purchaseRefund;

    @Column(name = "source_purchase_order_item_id", nullable = false)
