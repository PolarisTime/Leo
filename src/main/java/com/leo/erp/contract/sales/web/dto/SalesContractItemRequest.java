...
public record SalesContractItemRequest(
    ...
    public SalesContractItemRequest(Long id,
                                    String materialCode,
                                    String brand,
                                    String category,
                                    String material,
                                    ...
                                    BigDecimal unitPrice,
                                    BigDecimal amount) {
        this(id, null, materialCode, brand, category, material, spec, length, unit, quantity, quantityUnit,
                pieceWeightTon, piecesPerBundle, weightTon, unitPrice, amount);
    }

    public SalesContractItemRequest(String materialCode,
                                    String brand,
                                    String category,
                                    String material,
                                    String spec,
                                    ...
                                    BigDecimal unitPrice,
                                    BigDecimal amount) {
        this(null, null, materialCode, brand, category, material, spec, length, unit, quantity, quantityUnit,
                pieceWeightTon, piecesPerBundle, weightTon, unitPrice, amount);
    }
}
