...
class ResourcePermissionCatalogTest {
    ...
    void shouldIdentifyBusinessResource() {
        ...
        assertThat(ResourcePermissionCatalog.isBusinessResource("cash-reversal")).isTrue();
    }

    @Test
    void shouldIdentifyNonBusinessResource() {
        assertThat(ResourcePermissionCatalog.isBusinessResource("dashboard")).isFalse();
        assertThat(ResourcePermissionCatalog.isBusinessResource("ledger-adjustment")).isFalse();
        assertThat(ResourcePermissionCatalog.isBusinessResource("supplier-refund-receipt")).isFalse();
    }
    ...
    void shouldCheckAllowedAction() {
        ...
        assertThat(ResourcePermissionCatalog.isAllowed("purchase-refund", "audit")).isTrue();
        assertThat(ResourcePermissionCatalog.isAllowed("ledger-adjustment", "audit")).isFalse();
