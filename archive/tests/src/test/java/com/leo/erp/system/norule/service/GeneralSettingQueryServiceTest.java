...
class GeneralSettingQueryServiceTest {
    ...
    @Test
    void shouldOrderPurchaseRefundAndCashReversalRulesInDocumentFlowOrder() {
        ...
        GeneralSettingQueryService service = new GeneralSettingQueryService(
                noRuleRepository(List.of(salesOrder, cashReversal, purchaseRefund, purchaseInbound)),
                mapper(),
                () -> List.of()
        );
        ...
        assertThat(settingCodes(records)).containsExactly("RULE_PI", "RULE_PR", "RULE_SO", "RULE_CR");
    }
