...
class FreightBillItemRequestValidationTest {
    ...
    @Test
    void shouldRequirePositiveSourceSalesOrderItemId() {
        FreightBillItemRequest missingId = new FreightBillItemRequest(
                null, "SO001", null, null, null, null, "客户名称", null, "项目名称", null,
                "M001", "钢材", "品牌A", "类别A", "钢材", "10mm", "6m", 100, "件",
                BigDecimal.valueOf(0.500), 10, "B001", BigDecimal.valueOf(50.000), null, "仓库A",
                null, null, null
        );
        ...
        assertThat(violationFields(missingId)).contains("sourceSalesOrderItemId");
        assertThat(violationFields(nonPositiveId)).contains("sourceSalesOrderItemId");
    }
    ...
    void shouldAcceptNullOptionalFields() {
        FreightBillItemRequest item = new FreightBillItemRequest(
                null, "SO001", null, null, null, null, "客户名称", null, "项目名称", null,
                "M001", null, "品牌A", "类别A", "钢材", "10mm", null, 100, null,
                BigDecimal.valueOf(0.500), 10, null, null, null, null, null, null, 20L
        );
