...
class SalesOrderControllerTest {
    ...
    private final SalesOrderSourceCandidateService sourceCandidateService = mock(SalesOrderSourceCandidateService.class);
    private final HttpServletRequest request = mock(HttpServletRequest.class);
    private final SalesOrderController controller = new SalesOrderController(
            service,
            printExportService,
    ...
    @Test
    void controllerRequiresSalesOrderSourceCandidateService() {
        assertThat(SalesOrderController.class.getConstructors()).hasSize(1);
        assertThat(SalesOrderController.class.getConstructors()[0].getParameterTypes())
                .containsExactly(
                        SalesOrderService.class,
                        SalesOrderPrintExportService.class,
                        SalesOrderSourceCandidateService.class
                );
    }
